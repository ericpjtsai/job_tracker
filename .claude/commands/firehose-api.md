---
description: Firehose API reference — taps, rules, SSE stream, Lucene query syntax, rate limits, error codes, and curl/JS/Python examples. Use when implementing or discussing any Firehose API calls.
allowed-tools: [Bash]
---
