...
const DEFAULT_NON_DESIGN = ['lead', 'intern', 'internship', 'scholarship', 'researcher', 'strategist', 'motion designer', 'content designer', 'graphic designer', 'interior designer', 'multimedia designer', 'multi.media designer', 'packaging designer', 'engineer', 'ai trainer', 'job trends', 'salaries', 'data scientist', 'business analyst', 'client associate', 'product specialist', 'professor', 'nurse', 'licensed practical nurse', "founder.s office", 'growth marketing', 'creative producer', 'model kit', 'data entry', 'cybersecurity', 'solutions architect', 'solutions consultant', 'civil designer', 'mechanical designer', 'structural designer', 'landscape designer', 'cad designer', 'cad drafter', 'drafter', 'architectural designer', 'electrical designer', 'motion graphics designer', 'video editor', 'planner', 'writer', 'toy designer']
